...
<head>
    ...
    <title>Program Ekonomi - Yayasan Kaya Tene</title>
    <link rel="stylesheet" href="../css/style.css">
    <?php include '../partials/HeaderAssets.php'; ?>
    <style>
        .page-header {
            padding: 180px 0 100px;
            background: linear-gradient(rgba(5, 5, 6, 0.7), rgba(5, 5, 6, 0.95)), url('../Public/img/hero-2.jpeg') center/cover no-repeat;
            text-align: center;
            position: relative;
        }
        ...
        .initiative-item:hover {
            ...
            /* Highlight using secondary colour */
    ...
    <header class="page-header">
        <div class="container header-content">
            <h1 class="page-title">Program <span class="text-gradient"
                    style="background: linear-gradient(to right, #FFB703, #FFA000); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">Ekonomi</span>
            </h1>
            <p class="page-subtitle">Mendorong Kemandirian Ekonomi Masyarakat melalui pendampingan, pelatihan
                produktivitas, dan usaha mikro.</p>
        </div>
    </header>

    <section class="program-details container">
        <div class="detail-card glass">
            <h3>Berdaya secara <span class="text-gradient"
                    style="background: linear-gradient(to right, #FFB703, #FFA000); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">Ekonomi</span>
            </h3>
            <p>
                Yayasan Kaya Tene yakin bahwa perubahan sosial budaya yang baik harus ditunjang oleh pembebasan
                kemiskinan secara struktural maupun faktual. Program pemberdayaan ekonomi kami difokuskan pada
                memberikan "kail, bukan sekadar ikan". Dengan memanfaatkan kearifan dan sumber daya alam/tenaga khas
                masyarakat setempat.
            </p>
            <p>
                Ekosistem yang kita bangun bersama diarahkan untuk mengonsolidasi petani tangguh lokal, melatih
                pengrajin usaha kecil, hingga memperkenalkan modernisasi finansial.
            </p>
                    ...
                    while ($prog = $program_result->fetch_assoc()) {
                        ...
                        <div class="initiative-item" style="padding: 0; overflow: hidden; display: flex; flex-direction: column;">
                            ...
                            <div style="padding: 30px; flex: 1; display: flex; flex-direction: column; text-align: left;">
                                <div style="color: var(--secondary); font-size: 0.85rem; font-weight: 600; margin-bottom: 10px;"><i class="fa-regular fa-calendar" style="margin-right: 5px;"></i> ' . $tanggal . '</div>
