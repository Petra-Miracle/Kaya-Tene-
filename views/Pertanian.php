...
<head>
    ...
    <title>Program Pertanian & Peternakan - Yayasan Kaya Tene</title>
    <link rel="stylesheet" href="../css/style.css">
    <?php include '../partials/HeaderAssets.php'; ?>
    <style>
        .page-header {
            padding: 180px 0 100px;
            /* Placeholder organic background color */
            background: linear-gradient(rgba(5, 5, 6, 0.7), rgba(5, 5, 6, 0.95)), url('https://images.unsplash.com/photo-1595841696677-6489ffa3f699?ixlib=rb-4.0.3&auto=format&fit=crop&w=1600&q=80') center/cover no-repeat;
            text-align: center;
            position: relative;
        }
        ...
        .detail-card {
            ...
            border-top: 5px solid #d4a373; /* Earthy/Agriculture tone */
        ...
        .initiative-item:hover {
            ...
            background: rgba(212, 163, 115, 0.05); /* Highlight using earthy tone */
    ...
    <header class="page-header">
        <div class="container header-content">
            <h1 class="page-title">Program <span class="text-gradient"
                    style="background: linear-gradient(to right, #d4a373, #bc6c25); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">Pertanian
                    & Peternakan</span></h1>
            <p class="page-subtitle">Ketahanan pangan & kesejahteraan masyarakat pedesaan melalui integrasi pertanian, perikanan, dan peternakan organik berkelanjutan.</p>
        </div>
    </header>

    <section class="program-details container">
        <div class="detail-card glass">
            <h3>Ketahanan <span class="text-gradient"
                    style="background: linear-gradient(to right, #d4a373, #bc6c25); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">Pangan Lokal</span></h3>
            <p>
                Melalui pemberdayaan teknologi hidroponik, akuaponik, dan pengelolaan pupuk organik skala desa, Yayasan Kaya Tene turut berkontribusi membentuk kemandirian pangan masyarakat. 
            </p>
            <p>
                Program ini berfokus pada edukasi serta implementasi sistem yang dapat langsung meningkatkan kualitas gizi keluarga menggunakan pekarangan dan sumber daya maritim pesisir mereka sendiri.
            </p>
                    ...
                    while ($prog = $program_result->fetch_assoc()) {
                        ...
                        <div class="initiative-item" style="padding: 0; overflow: hidden; display: flex; flex-direction: column;">
                            ...
                            <div style="padding: 30px; flex: 1; display: flex; flex-direction: column; text-align: left;">
                                <div style="color: #d4a373; font-size: 0.85rem; font-weight: 600; margin-bottom: 10px;"><i class="fa-regular fa-calendar" style="margin-right: 5px;"></i> ' . $tanggal . '</div>
