    ...
    if (!empty($judul) && !empty($isi)) {
        ...
        if (empty($error)) {
            ...
            if ($stmt->execute()) {
                ...
                $error = "Gagal mempublikasikan berita: " . $conn->error;
            }
        }
    } else {
        ...
        <main class="main-content">
            <div class="dashboard-header">
                <div class="header-title">
                    <h1>Tulis Berita</h1>
                    <p class="text-muted" style="font-size: 1.1rem;">Buat dan publikasikan kegiatan terbaru Yayasan Kaya
                        Tene.</p>
                </div>
            ...
            <div class="form-container glass">
                ...
                <form method="POST" action="" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="gambar" class="form-label">Gambar Sampul (Opsional)</label>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="isi" name="isi" class="form-control"
                            ...
                            required><?= isset($isi) ? htmlspecialchars($isi) : '' ?></textarea>
                    </div>

                    <button type="submit" class="btn-submit">Publikasikan Berita Sekarang</button>
